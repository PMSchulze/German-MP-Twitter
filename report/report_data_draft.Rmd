...
packages_required <- c(
  "ggcorrplot", "gridExtra", "htmltools", "huge", "knitr", "scales", "stm", "stringi", "tidyverse", "tm"
)
...
After this global-level analysis of topics, in particular their labeling and proportions, we now proceed to analyze metadata information (i.e., document-level covariates) and its impact on topic proportions.
