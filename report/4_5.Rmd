...
```{r echo=FALSE}
plot8_train_party <- topic_props_train %>%
                      ggplot(aes(!!as.symbol(covariate), !!as.symbol(topic_number_long))) +
                      geom_boxplot(outlier.shape = NA) +
                      geom_point() +
                      labs(y = "topic proportion", 
...
plot8_test_party <-  topic_props_test %>%
                      ggplot(aes(!!as.symbol(covariate), !!as.symbol(topic_number_long))) +
                      geom_boxplot(outlier.shape = NA) +
                      geom_point() +
                      labs(y = "topic proportion", 
...
gridExtra::grid.arrange(plot8_train_party, plot8_test_party, ncol = 2)
```
...
plot1_test_time <-   topic_props_test %>%
                      select(,topic_number+1) %>%
...
gridExtra::grid.arrange(plot1_train_time, plot1_test_time, ncol = 2)
```
