...
\begin{itemize}
\item First step: inspection of top words
\begin{table}[h!]
\centering
\resizebox{8cm}{!}{%
\begin{tabular}{|l|}
...
\begin{itemize}
\item graph: weighted and unweighted props
\item XXX
\end{itemize}
\end{frame}
...
\begin{itemize}
\item topic 3 and 6 overlap
\item topic correlation graph
\end{itemize}
\end{frame}
