...
\frametitle{Introduction}
\begin{itemize}
\item In this project: application of the  \cite{roberts2016model} to a self-created dataset 
\item Key contributions of this project:
	...
	\item Application of the \textit{Structural Topic Model} (STM) to German MPs' Twitter communication
...
\item Variational inference: positing a simple distribution family $q$
\item Mean-field variational inference: positing full factorizability of approximating posterior $q$
