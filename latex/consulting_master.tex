...
\begin{titlepage}
	...
	\vspace{0.5cm}
	{\scshape\Large Statistical Consulting Project (MSc Statistics) \par}
	\vspace{1.0cm}
	...
	%\author[1]{Patrick Schulze}%
  		%\thanks{E-mail: \texttt{Pa.Schulze@campus.lmu.de}}}
	%\affil[1]{Department, College}
	\vspace{1.0cm}
	\begin{itemize}
	\item[] Project partners: \textit{Prof. Dr. Paul W. Thurner, Sandra Wankmüller \\
	(Geschwister Scholl Institute of Political Science, LMU)}
	\item[] Supervisors: \textit{Prof. Dr. Christian Heumann, Matthias Aßenmacher}
	\end{itemize}
	\vspace{1.0cm}
	\abstract{
\noindent
...
\input{./kapitel/method_of_composition_new}
