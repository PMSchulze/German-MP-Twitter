...
The current political landscape of Germany consists of six parties: the Christian Democrats (\textit{CDU/CSU}), the Social Democrats (\textit{SPD}), the right-wing \textit{AfD}, the Greens (\textit{Bündnis 90/Die Grünen}), the Left Party (\textit{Die Linke}), and the liberal \textit{FDP}. These parties are represented in the German parliament (\textit{Bundestag}) according to the votes obtained during the 2017 German federal election (\textit{Bundestagswahl}), which took place on September 24, 2017. The legislative period amounts to 4 years, thus ending around September 2021. The parliament currently contains a total of 709 seats. The large majority of members of the German parliament (\textit{(Bundestags-)Abgeordnete}) are assigned a single electoral district (\textit{Wahlkreis}), the remaining ones do not have one.
